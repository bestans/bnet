...
type ZlShareFrameBuilder struct {
	lenWriteBuff []byte
}

//func (z *ZlShareFrameBuilder) TryDecodeFrame(readData []byte) (messageData []byte, readLen int, success bool) {
//	n, l :=  ShareDecode(readData, 32)
//	if l <= 0 {
//		return
//	}
//	readLen = l + int(n)
//}
//
//func (z *ZlShareFrameBuilder) EncodeFrame(messageData []byte, writeBuf *inet.SocketBuffer) (writeBuffFull bool, err error) {
//	panic("implement me")
//}

//func (z *ZlShareFrameBuilder) Startup() error {
//	z.lenWriteBuff = make([]byte, lengthFixedNeedBytes)
//	return nil
//}
